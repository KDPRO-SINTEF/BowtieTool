...
window.API_VERSIONNING_DIAGRAMS = window.API_VERSIONNING_DIAGRAMS || window.API_DOMAIN + '/api/diagram/versions/'; // + {graphid}
window.API_SWITCH_VERSION = window.API_SWITCH_VERSION || window.API_DOMAIN + '/api/diagram/versions/';